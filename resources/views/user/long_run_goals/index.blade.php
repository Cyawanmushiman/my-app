...
<div class="container">
    <x-parts.basic_card_layout>
        <x-slot name="cardHeader">
            <h4 class="my-2">長期目標一覧：{{ $longRunGoals->total() . '件中' . $longRunGoals->firstItem() . '-' . $longRunGoals->lastItem() }}件</h4>
            <a href="{{ route('user.long_run_goals.create') }}" class="btn btn-primary">作成する</a>
        </x-slot>
