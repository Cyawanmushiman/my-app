...
<div class="container">
    <x-parts.basic_card_layout>
        <x-slot name="cardHeader">
            ...
            <a href="{{ route('user.inspires.create') }}" class="btn btn-primary">作成する</a>
        </x-slot>
                    ...
                    @if($inspires->isNotEmpty())
                        @foreach($inspires as $inspire)
                            <tr>
                                ...
                                <td class="text-nowrap px-2 text-center"><a href="{{ route('user.inspires.edit', $inspire) }}">{{ $inspire->comment }}</a></td>
                                <td class="text-nowrap px-2 text-center">
